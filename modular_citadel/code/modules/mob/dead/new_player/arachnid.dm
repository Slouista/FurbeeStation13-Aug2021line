/datum/sprite_accessory/arachnid_legs
	icon = 'modular_citadel/icons/mob/arachnid_legs.dmi'
...
/datum/sprite_accessory/arachnid_spinneret
	icon = 'modular_citadel/icons/mob/arachnid_spinneret.dmi'
	//relevant_layers = list(BODY_BEHIND_LAYER, BODY_ADJ_LAYER, BODY_FRONT_LAYER)
...
/datum/sprite_accessory/arachnid_mandibles
	icon = 'modular_citadel/icons/mob/arachnid_mandibles.dmi'
