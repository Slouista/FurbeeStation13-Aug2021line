/datum/species/arachnid
	name = "Arachnid"
	id = "arachnid"
	icon_limbs = 'modular_citadel/icons/mob/arachnid_parts.dmi'
	say_mod = "chitters"
	default_color = "00FF00"
	species_traits = list(LIPS, NOEYESPRITES, NO_UNDERWEAR)
	inherent_biotypes = list(MOB_ORGANIC, MOB_HUMANOID, MOB_BUG)
	mutant_bodyparts = list("arachnid_legs", "arachnid_spinneret", "arachnid_mandibles")//, "insect_fluff")
	default_features = list("arachnid_legs" = "Plain", "arachnid_spinneret" = "Plain", "arachnid_mandibles" = "Plain")//, "insect_fluff" = "Plain")
	attack_verb = "slash"
...
/datum/species/proc/check_weakness(obj/item, mob/living/attacker) //f
	return FALSE
